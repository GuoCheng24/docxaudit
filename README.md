...
[![test](https://github.com/GuoCheng24/docxaudit/actions/workflows/test.yml/badge.svg)](https://github.com/GuoCheng24/docxaudit/actions/workflows/test.yml) [![python](https://img.shields.io/badge/python-3.9%2B-blue)](https://www.python.org/) [![license](https://img.shields.io/badge/license-MIT-green)](LICENSE)
...
<sub>The figure above is generated by <a href="docs/silent-losses_figure.py">docs/silent-losses_figure.py</a> — <code>pip install git+https://github.com/GuoCheng24/sciglyph</code> and run it to reproduce <code>docs/silent-losses.png</code> byte for byte.</sub>
...
When it lands, `pip install docxaudit` will too.</sub>
