...
<sub>The figure above is generated by <a href="https://github.com/GuoCheng24/docxaudit/blob/main/docs/silent-losses_figure.py">docs/silent-losses_figure.py</a> — <code>pip install sciglyph</code> and run it to reproduce <code>docs/silent-losses.png</code> byte for byte.</sub>
